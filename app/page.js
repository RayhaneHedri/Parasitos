...
const Home = () => {
  return (
    <section className="conta flex-center flex-col w-full">
      ...
      <h3 className="catch_text">Are you ready to start your experience with us?</h3>
      
      
      <button type="button" className="primary_btn">Create Account</button>
      <h1 className="head_text">MEET OUR TEAM</h1>
      <div className="circle-img">
        <img src="/assets/IMG_1998.jpg" alt="Circle image" />
      </div>
      <button type="button" className="primary_btn">Learn More</button>
      <h1 className="head_text">OUR PRODUCTS</h1>
      ...
      <button type="button" className="primary_btn">See More</button>
